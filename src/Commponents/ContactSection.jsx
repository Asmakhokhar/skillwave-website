    ...
    return (
        <section className='bg-white dark:bg-gray-900 text-black dark:text-white py-12 px-4 sm:px-6 lg:px-8'>
            <div className='max-w-6xl mx-auto'>
                <h1 className='text-3xl sm:text-4xl text-center mb-12 text-[#2ca903] font-semibold'>
                    Contact Us
                </h1>
                ...
                <div className='flex flex-col lg:flex-row gap-8 lg:gap-12'>
                    ...
                    <div className='w-full lg:w-1/2 bg-gray-50 dark:bg-gray-800 rounded-xl p-6 sm:p-8 shadow-lg'>
                        ...
                        <form className='space-y-4'>
                            ...
                            <button 
                                type="submit"
                                className='px-8 py-3 bg-[#2ca903] hover:bg-[#248a02] text-white font-medium rounded-lg transition-colors duration-300 w-full sm:w-auto'
                            >
                                Send Message
                            </button>
                        </form>
